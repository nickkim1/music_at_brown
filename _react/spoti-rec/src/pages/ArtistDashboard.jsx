        ...
        try {
            ...
            await fetch("http://127.0.0.1:5000/artistdashboard", {
              ...
              .then((data) => {
                ...
                document.getElementById("form-artist-img").value = data["profile"]["img"]; 
                document.getElementById("form-artist-name").value = data["profile"]["name"]; 
                document.getElementById("form-artist-loc").value = data["profile"]["location"]; 
                document.getElementById("form-handle-link-spotify").value = data["profile"]["spotify"]
                document.getElementById("form-handle-link-twitter").value = data["profile"]["twitter"]
                document.getElementById("form-handle-link-facebook").value = data["profile"]["facebook"]
                document.getElementById("form-handle-link-insta").value = data["profile"]["insta"]
                document.getElementById("artist-description").value = data["profile"]["description"]
                document.getElementById("artist-booking-info").value = data["profile"]["booking"]
            ...
            <div className="form-wrapper">
                ...
                <form className="artist-signup-form" id="artist-signup-form">
                    ...
                    <div className="form-separator"></div>
                        <p>Edit your profile! Click the button below to fetch current profile info</p>
                        <button className="dashboard-fetch" onClick={getArtistProfile}>Fetch past profile info!</button>
                    <div className="form-separator"></div>
